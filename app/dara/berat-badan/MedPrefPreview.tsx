...
export function MedPrefPreview() {
  ...
  return (
    <div role="radiogroup" aria-label="Preferensi obat GLP-1" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
      ...
      <MedicationCard name="Mounjaro®" molecule="tirzepatide" cadence="1× / minggu" results="hingga ±20%" priceLabel="Rp 4.400.000/bln" selected={pref === 'mounjaro'} onSelect={() => setPref('mounjaro')} />
    </div>
  );
}
